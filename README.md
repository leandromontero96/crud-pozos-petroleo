...
Desarrollado como sistema de gestión para la industria petrolera.
...
**Nota**: Este es un sistema de demostración. Para uso en producción, se recomienda agregar capas adicionales de seguridad, autenticación y validación.
